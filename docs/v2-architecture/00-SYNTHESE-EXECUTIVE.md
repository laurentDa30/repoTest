...
| **Phase 3** | 2-3 mois | Portails client/amba Livewire 3, migration cloud, **provisioning auto de régions** |
...
> - `04-FRONTEND.md` — Livewire 3 / Alpine.js / Tailwind + revue backend
